# Generated by Powerlevel10k configuration wizard on 2026-03-30 at 23:55 KST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    username                # current shell user (non-root)
    username_root           # current shell user (root)
  ...
  function prompt_username() {
    if [ "$EUID" -ne 0 ]; then
      p10k segment -f 6 -t '%n'
    fi
  }

  function instant_prompt_username() {
    if [ "$EUID" -ne 0 ]; then
      prompt_username
    fi
  }
  ...
  # User name (root)
  typeset -g POWERLEVEL9K_USERNAME_ROOT_BACKGROUND=125
  typeset -g POWERLEVEL9K_USERNAME_ROOT_FOREGROUND=231

  function prompt_username_root() {
    if [ "$EUID" -eq 0 ]; then
      p10k segment -f 231 -b 125 -i $'\uF2FC' -t '%n'
    fi
  }

  function instant_prompt_username_root() {
    if [ "$EUID" -eq 0 ]; then
      prompt_username_root
    fi
  }
  ##################################
